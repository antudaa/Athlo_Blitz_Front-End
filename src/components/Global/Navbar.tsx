                            ...
                            <ul className="lg:flex items-center flex-col mt-4 lg:mt-0 lg:flex-row">
                                ...
                                <li className="relative">
                                    <button data-dropdown-toggle="menu1"
                                        className="flex items-center justify-between text-gray-500 text-base lg:text-base font-medium hover:text-indigo-700 transition-all duration-500 mb-2  lg:mr-6 md:mb-0 lg:text-left text-center m-auto lg:m-0">Products
                                    ...
                                    <div id="menu1"
                                        ...
                                        <div className="flex justify-between">
                                            ...
                                            <ul className="text-sm text-gray-700 dark:text-gray-400 w-1/2"
                                ...
                                <li className="relative">
                                    <button data-dropdown-toggle="menu2"
                                        className="flex items-center justify-between text-gray-500 text-base lg:text-base font-medium hover:text-indigo-700 transition-all duration-500 mb-2 lg:mr-6 md:mb-0 lg:text-left text-center m-auto lg:m-0">Features
                                        <svg className="w-3 h-2 ml-1.5 " width="10" height="6" viewBox="0 0 10 6" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                                d="M1 1L3.58579 3.58579C4.25245 4.25245 4.58579 4.58579 5 4.58579C5.41421 4.58579 5.74755 4.25245 6.41421 3.58579L9 1"
