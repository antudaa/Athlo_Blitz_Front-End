...
import { useGetAllBookingsByAdminQuery } from "../../../redux/features/booking/bookingApi";
...
const ManageAllBookingsTable: React.FC = () => {
    ...
    const { data: Bookings, isLoading: bookingIsLoading } = useGetAllBookingsByAdminQuery({
        token,
        page,
        limit,
    });
...
export default ManageAllBookingsTable;
