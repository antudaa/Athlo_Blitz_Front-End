...
const ErrorPage = () => {
    return (
        <div className="w-full flex-col justify-start items-center lg:gap-16 gap-10 inline-flex ">
            <div className="border border-indigo-300  min-h-screen rounded-lg w-full">
                ...
                <div className="relative h-[calc(550px-85px)] flex justify-center items-center flex-col">
                    ...
                    <div className="block text-center mt-5">
                        ...
                        <Link to={`/`}
                            className="bg-gradient-to-r from-indigo-400 to-blue-400 hover:from-indigo-500 hover:to-blue-500 text-white font-semibold px-6 py-3 rounded-md mr-6"
                        >
                            HOME
                        </Link>
                    </div>
        ...
        // <div className="bg-gradient-to-r from-green-200 to-green-100 min-h-screen flex items-center justify-center">
        ...
        //                 </p>
        //                 <Link to={`/`}
        //                     className="bg-gradient-to-r from-green-400 to-blue-400 hover:from-pink-500 hover:to-orange-500 text-white font-semibold px-6 py-3 rounded-md mr-6"
        //                 >
        //                     HOME
        //                 </Link>
        //             </div>
